...
class HotelSelectionItemHighlightForSuggestionBusEvent<HotelSelectionItemHighlightForSuggestionBusEventData>
    extends BaseDataEvent<HotelSelectionItemHighlightForSuggestionBusEventData, dynamic, WidgetId> {
  HotelSelectionItemHighlightForSuggestionBusEvent({required super.data});
}
